...
public abstract class AbstractMealServiceTest extends AbstractServiceTest {
    ...
    void create() throws Exception {
        ...
        newMeal.setId(newId);
        assertMatchMeals(created, newMeal);
        assertMatchMeals(service.get(newId, USER_ID), newMeal);
    }

    @Test
    void get() throws Exception {
        Meal actual = service.get(ADMIN_MEAL_ID, ADMIN_ID);
        assertMatchMeals(actual, ADMIN_MEAL1);
    }
    ...
    void update() throws Exception {
        ...
        assertMatchMeals(service.get(MEAL1_ID, USER_ID), updated);
    }
    ...
    void getAll() throws Exception {
        assertMatchMeals(service.getAll(USER_ID), MEALS);
    }

    @Test
    void getBetween() throws Exception {
        assertMatchMeals(service.getBetweenDates(
    ...
    public void getBetweenWithNullDates() throws Exception {
        assertMatchMeals(service.getBetweenDates(null, null, USER_ID), MEALS);
    }
